...
var RecipeDataContent = [
  ...
  RecipeData(
    ...
    howTo: [
      "Goreng telur rebus di minyak banyak dan panas sampai telur berkulit kecokelatan. Angkat dan tiriskan.",
      "Panaskan wajan, tuang minyak, tumis bumbu halus sampai layu.",
      "Masukkan bumbu cemplung tumis sampai wangi masukkan pete.",
      "Kemudian masukkan bahan lainnya, tes rasa. Terakhir masukkan telur yang sudah digoreng. Tumis sebentar agar bumbu meresap. Siap sajikan.",
    ],
  ),
  RecipeData(
    type: 'Favorite',
